...
export interface TableCardSkeletonProps extends React.HTMLAttributes<HTMLDivElement> {
  columns?: number;
  rows?: number;
}

export const TableCardSkeleton: React.FC<TableCardSkeletonProps> = ({ columns = 5, rows = 5, className, ...props }) => (
  ...
  <div className={cn("flex h-screen bg-background w-full dark:bg-gray-950", className)} {...props}>
    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        {/* Major table layout */}
        <TableCardSkeleton columns={4} rows={3} />
      </div>
    </div>
  </div>
);
