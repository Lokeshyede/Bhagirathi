  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden" aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
      ...
      <div className="absolute inset-y-0 right-0 pl-10 max-w-full flex">
        ...
        >
          <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between bg-gray-50 dark:bg-gray-955/20">
            <div className="flex items-center gap-2">
              ...
              {unreadCount > 0 && (
                <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold bg-red-100 text-red-700 dark:bg-red-950/40 dark:text-red-500">
                  {unreadCount} new
                </span>
              )}
            </div>
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-955/20">
            <Link
              to="/notifications"
              onClick={closeDrawer}
