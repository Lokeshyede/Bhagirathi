  ...
  return (
    <div ref={containerRef} className={cn("w-full relative select-none", className)} {...props}>
      ...
      {hoveredIndex !== null && points[hoveredIndex] && (
        <div
          className="absolute z-25 pointer-events-none bg-white/95 border border-border shadow-dropdown p-2.5 rounded-button text-xs font-semibold text-text-primary backdrop-blur-sm dark:bg-gray-900/90 dark:border-gray-800 dark:text-white"
          style={{
