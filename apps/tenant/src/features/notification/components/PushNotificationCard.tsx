        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-amber-700 dark:text-amber-300 mt-0.5">
              Notifications are blocked in your browser settings. To receive rent reminders and payment updates, allow notifications in your browser settings.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[11px] text-gray-500 dark:text-gray-400">
            Get instant alerts for payment receipts, rent due reminders, and complaint updates.
          </p>
