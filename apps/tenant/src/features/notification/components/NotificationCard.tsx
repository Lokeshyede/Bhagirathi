    ...
    <div
      className={`group relative flex gap-4 p-4 rounded-xl border transition-all duration-200 ${
        isUnread
          ...
          : "bg-white border-gray-150 hover:border-gray-200 dark:bg-gray-900 dark:border-gray-800 dark:hover:border-gray-755"
      }`}
    >
      {isUnread && (
      ...
      <div className="flex-1 min-w-0 pr-8">
        ...
        <Link to={redirectLink} className="block group-hover:text-red-650 dark:group-hover:text-red-400 transition-colors cursor-pointer">
