          ...
          <div className="sm:hidden flex items-center gap-1.5">
            {hasActiveFilters && (
              <button
                ...
                className="h-11 px-2.5 rounded-xl border border-red-200 dark:border-red-900/40 bg-red-50 dark:bg-red-950/20 text-red-600 dark:text-red-400 text-xs font-bold inline-flex items-center gap-1 transition-colors cursor-pointer shrink-0"
              >
